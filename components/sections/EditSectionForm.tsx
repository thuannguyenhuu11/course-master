...
const EditSectionForm = ({ section, courseId, isCompleted }: EditSectionFormProps) => {
  ...
  return (
    <>
      ...
      <h1 className="text-xl font-bold ">Section Detail</h1>
      <p className="text-sm font-medium mr-2">
        Complete this section with detailed information, good video and resources to give your students the best
        learning experience.
      </p>
